...
<body>
    <div class="container mt-5">
        ...
        <h1 class="text-center mb-4">Ya Puedes Ordenar Tu Comida</h1>
        ...
        {{-- <form id="orderForm" action="/orden.store" method="POST" class="mt-5">
            @csrf
            <input type="hidden" name="table_id" value="1"> 
            <div id="orderDetails"></div>
            <button type=""  class="btn btn-primary btn-block">
                <a href="{{ route('orden.store')}}" class="btn btn-primary">ordenar</a>
            </button>
        </form> --}}

        <form id="orderForm" action="{{ route('orden.store') }}" method="POST" class="mt-5">
            @csrf
            <input type="hidden" name="table_id" value="1">
